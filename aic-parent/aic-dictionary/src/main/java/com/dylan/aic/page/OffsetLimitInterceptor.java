...
import com.dylan.aic.page.dialect.Dialect;
import com.dylan.aic.page.domain.PageBounds;
import com.dylan.aic.page.domain.PageList;
import com.dylan.aic.page.domain.Paginator;
import com.dylan.aic.page.support.PropertiesHelper;
import com.dylan.aic.page.support.SQLHelp;


/**
  * @ClassName: OffsetLimitInterceptor
  * @Description: 为MyBatis提供基于方言(Dialect)的分页查询的插件,将拦截Executor.query()方法实现分页方言的插入.
  * @author Dylan
  * @date 2016年1月14日
  *
  */
...
public class OffsetLimitInterceptor implements Interceptor{
    private static Logger logger = LogManager.getLogger(OffsetLimitInterceptor.class);
