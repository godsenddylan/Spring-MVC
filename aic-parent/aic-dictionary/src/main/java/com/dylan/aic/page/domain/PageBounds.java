package com.dylan.aic.page.domain;
...
import com.dylan.aic.util.StringUtil;
...
public class PageBounds extends RowBounds implements Serializable {
    ...
    public final static int LIMIT_SIZE = 10;
    /** 页号 */
    protected int page = NO_PAGE;
    /** 分页大小 */
//    protected int limit = NO_ROW_LIMIT;
    protected int limit = LIMIT_SIZE; //默认分页大小
    /** 分页排序信息 */
    ...
    public PageBounds(Object page, Object limit){
		this(Integer.valueOf(StringUtil.isNullOrEmpty(page)?"1":page.toString()).intValue(), Integer.valueOf(StringUtil.isNullOrEmpty(limit)?"10":limit.toString()).intValue());
    }
